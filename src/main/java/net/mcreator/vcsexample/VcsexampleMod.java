package net.mcreator.vcsexample;
...
@Mod("vcsexample")
public class VcsexampleMod {
	public static final Logger LOGGER = LogManager.getLogger(VcsexampleMod.class);
	public static final String MODID = "vcsexample";

	public VcsexampleMod(IEventBus modEventBus) {
